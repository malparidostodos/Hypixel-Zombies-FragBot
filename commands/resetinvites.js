...
module.exports = (bot, msg, args, sender, adminList, botsMuted, whitelist, translateOriginal, sendToWebhook, activeParties, fs, path, reloadConfigs, invitationCounts, saveInvitationCounts, bots) => {
    ...
    for (const botName in invitationCounts) {
        invitationCounts[botName] = 0;
    }
